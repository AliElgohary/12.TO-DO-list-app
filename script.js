function addTask() {
    ...
    document.querySelector("table").innerHTML += `
          ...
          <td scope="col"><button class="btn btn-success" id="delete" onclick="deleteTask(${task.taskNumber})" >delete</button></td>
          </tr>
          `;
    taskCount++;
  }
  function deleteTask(taskNumber) {
    tasks.splice(tasks.indexOf(tasks.find(task=> task.taskNumber == taskNumber)), 1);
    console.log(tasks);
